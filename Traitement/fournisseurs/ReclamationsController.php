...
class ReclamationController {
    ...
    public function __construct() {
        // Utilisation de la connexion via DBConnection
        $this->db = DBConnection::getInstance();  // Utilise la connexion Singleton
        $conn = $this->db->getConnection();        // Récupère l'objet PDO
