...
// Utilisation de la connexion Singleton DBConnection
$db = DBConnection::getInstance();
$conn = $db->getConnection();

// Initialisation des modèles et du contrôleur avec la connexion PDO
$reclamationModel = new Reclamation($conn);
$clientModel = new ClientModel($conn); // Ajouté pour assurer la gestion des clients
$controller = new ReclamationController($reclamationModel, $clientModel); // Passer le clientModel au contrôleur
