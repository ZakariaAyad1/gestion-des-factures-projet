                ...
                <?php if (!empty($factures)): ?>
                    <?php foreach ($factures as $facture): ?>
                        <tr>
                            ...
                            <td>
                                <span class="status <?= $facture['etat'] == 'payee' ? 'paid' : ($facture['etat'] == 'non_payee' ? 'unpaid' : ($facture['etat'] == 'en_attente' ? 'pending' : 'refunded')) ?>">
                                    <?= ucfirst(str_replace('_', ' ', $facture['etat'])) ?>
                                </span>
                            </td>
                            <td>
                                <a href="../../factures/facture_<?= $facture['facture_id'] ?>.pdf" class="download-link">
                                    Télécharger
                                </a>
